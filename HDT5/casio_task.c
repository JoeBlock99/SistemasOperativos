...
// iteraciones que se dieron por segundo del loop
#define LOOP_ITERATIONS_PER_MILLISEC 178250

//Definiciones de medidas de tiempo
...
// Se ejecuta la simulacion con delay
void burn_1millisecs() {
	unsigned long long i;
	for(i=0; i<LOOP_ITERATIONS_PER_MILLISEC; i++);
}

// Ejecucion de simulacion con delay variable
...
// Se restablece a valores predefinidos
...
// Se imprimen los parametros del task
...
// Se restablece a los valores predefinidos del tiempo
...
// Se setea un cronometro de señal
...
// Se imprime el valor de la señal de tiempo en segundos
...
// Se ejecuta el Job que se asigno
void do_work(int s)
{
