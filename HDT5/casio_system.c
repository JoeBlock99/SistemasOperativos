...
struct casio_tasks_config {
	...
	double min_exec;
	double max_exec;
	double min_inter_arrival; // parametro de tiempo
	double max_inter_arrival; // parametro de tiempo
	double deadline;
	double min_offset;
	double max_offset;
};
...
// Se imprimen todos los task almacenados
...
// Se restablecen los valores predefinidos de casio_tasks
...
// Se obtiene la información sobre la configuración de casio task
...
// Print sobre proceso ejecución / ayuda
void help(char* name)
{
...
int main(int argc, char *argv[])
{
	...
	start_simulation();
	// Se espera que termine la simulacion
	pause();
